	...
	<div class="container hero">
		<div class="hero-item first">
			<div style="position: relative">
				...
				<img on:click={clickNextImage} style="position: absolute; top: 0; left: 0; right: 0; opacity: {nextOpacity};" class="hero-img" src="{heroImage}"/>
			</div>
		</div>
		<div class="hero-item">
			...
			<p class="large-paragraph">
				...
				See our first exhibition Digitally Specific today.
			</p>
			<a
